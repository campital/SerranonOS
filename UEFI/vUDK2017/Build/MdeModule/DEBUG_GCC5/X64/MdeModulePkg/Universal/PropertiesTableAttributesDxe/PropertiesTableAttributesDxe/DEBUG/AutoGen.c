...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAA48FBB2, 0x9F87, 0x4DFD, {0xB4, 0x16, 0x57, 0x59, 0x38, 0xF0, 0xC8, 0xF4}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PropertiesTableAttributesDxe";
...
{
  return InitializePropertiesTableAttributesDxe (ImageHandle, SystemTable);
}

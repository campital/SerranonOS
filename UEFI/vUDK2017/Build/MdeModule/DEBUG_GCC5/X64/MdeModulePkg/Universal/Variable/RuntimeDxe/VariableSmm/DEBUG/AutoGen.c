...
#define _PCD_TOKEN_PcdSpinLockTimeout  149U
...
#define _PCD_TOKEN_PcdVarCheckVfrDriverGuidArray  98U
  ...
  )
{
  ...
  Status = VarCheckUefiLibNullClassConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);

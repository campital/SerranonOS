...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xF7FDE4A6, 0x294C, 0x493c, {0xB5, 0x0F, 0x97, 0x34, 0x55, 0x3B, 0xB7, 0x57}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CapsuleX64";

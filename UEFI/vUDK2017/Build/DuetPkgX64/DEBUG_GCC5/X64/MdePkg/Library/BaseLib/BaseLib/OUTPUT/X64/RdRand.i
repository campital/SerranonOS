# 1 "/home/william/SerranonOS/UEFI/vUDK2017/MdePkg/Library/BaseLib/X64/RdRand.nasm"
# 1 "<built-in>"
# 1 "<command-line>"
# 31 "<command-line>"
...
;
; BOOLEAN InternalX86RdRand16 (UINT16 *Rand);
;------------------------------------------------------------------------------
...
; Return ((BOOLEAN)(1==1)) if Rand generated successfully, or ((BOOLEAN)(0==1)) if not.
;
; BOOLEAN InternalX86RdRand32 (UINT32 *Rand);
;------------------------------------------------------------------------------
...
; Return ((BOOLEAN)(1==1)) if Rand generated successfully, or ((BOOLEAN)(0==1)) if not.
;
; BOOLEAN InternalX86RdRand64 (UINT64 *Random);
;------------------------------------------------------------------------------

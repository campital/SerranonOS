...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x38A0EC22, 0xFBE7, 0x4911, {0x8B, 0xC1, 0x17, 0x6E, 0x0D, 0x6C, 0x1D, 0xBD}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IsaAcpi";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiIsaAcpiProtocolGuid = { 0x64a892dc, 0x5561, 0x4536, { 0x92, 0xc7, 0x79, 0x9b, 0xfc, 0x18, 0x33, 0x55 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdIsaAcpiCom1Enable = _PCD_VALUE_PcdIsaAcpiCom1Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdIsaAcpiCom2Enable = _PCD_VALUE_PcdIsaAcpiCom2Enable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdIsaAcpiPs2KeyboardEnable = _PCD_VALUE_PcdIsaAcpiPs2KeyboardEnable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdIsaAcpiPs2MouseEnable = _PCD_VALUE_PcdIsaAcpiPs2MouseEnable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdIsaAcpiFloppyAEnable = _PCD_VALUE_PcdIsaAcpiFloppyAEnable;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdIsaAcpiFloppyBEnable = _PCD_VALUE_PcdIsaAcpiFloppyBEnable;
...
{
  return PcatIsaAcpiDriverEntryPoint (ImageHandle, SystemTable);
}

...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x928EF6D4, 0x72BC, 0x4686, {0xB5, 0x7B, 0x1E, 0xEB, 0x6A, 0xBD, 0x4F, 0x93}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AcpiReset";

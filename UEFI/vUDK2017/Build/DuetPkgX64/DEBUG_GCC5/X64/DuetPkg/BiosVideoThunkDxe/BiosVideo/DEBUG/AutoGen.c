...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x29CF55F8, 0xB675, 0x4f5d, {0x8F, 0x2F, 0xB8, 0x7A, 0x3E, 0xCF, 0xD0, 0x63}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BiosVideo";
...
{
  return BiosVideoDriverEntryPoint (ImageHandle, SystemTable);
}

...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x35C0C168, 0x2607, 0x4e51, {0xBB, 0x53, 0x44, 0x8E, 0x3E, 0xD1, 0xA8, 0x7F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PciBusNoEnumerationDxe";

...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xA17F4A89, 0x5F19, 0x444f, {0xB7, 0xBE, 0x48, 0x19, 0x5E, 0x05, 0x75, 0xDB}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmbiosGenDxe";
...
{
  return SmbiosGenEntrypoint (ImageHandle, SystemTable);
}
...
//
unsigned char SmbiosGenDxeStrings[] = {

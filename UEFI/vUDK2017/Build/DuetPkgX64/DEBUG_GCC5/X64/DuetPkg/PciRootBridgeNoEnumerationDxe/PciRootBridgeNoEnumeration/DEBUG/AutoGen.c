...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0F7EC77A, 0x1EE1, 0x400f, {0xA9, 0x9D, 0x7C, 0xBD, 0x1F, 0xEB, 0x18, 0x1E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PcatPciRootBridge";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiPciOptionRomTableGuid = { 0x7462660F, 0x1CBD, 0x48DA, { 0xAD, 0x11, 0x91, 0x71, 0x79, 0x13, 0x83, 0x1C }};
...
{
  return InitializePcatPciRootBridge (ImageHandle, SystemTable);
}

...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBF89F10D, 0xB205, 0x474f, {0x96, 0xE3, 0x7A, 0x7B, 0xB1, 0xB4, 0xA4, 0x07}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VgaClassDxe";
...
{
  return InitializeVgaClass (ImageHandle, SystemTable);
}

...
#define _PCD_TOKEN_PcdIsaBusSupportedFeatures  135U
#define _PCD_SIZE_PcdIsaBusSupportedFeatures 1
#define _PCD_GET_MODE_SIZE_PcdIsaBusSupportedFeatures  _PCD_SIZE_PcdIsaBusSupportedFeatures 
#define _PCD_VALUE_PcdIsaBusSupportedFeatures  0x5U

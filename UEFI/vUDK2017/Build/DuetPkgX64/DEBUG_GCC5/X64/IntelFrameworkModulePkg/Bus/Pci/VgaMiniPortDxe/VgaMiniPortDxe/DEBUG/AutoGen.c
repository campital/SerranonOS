...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x15C5E761, 0x58D8, 0x461a, {0x91, 0x73, 0xCA, 0xB0, 0x20, 0x91, 0x62, 0x64}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VgaMiniPort";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiVgaMiniPortProtocolGuid = { 0xc7735a2f, 0x88f5, 0x4882, { 0xae, 0x63, 0xfa, 0xac, 0x8c, 0x8b, 0x86, 0xb3 }};
...
{
  return PciVgaMiniPortDriverEntryPoint (ImageHandle, SystemTable);
}

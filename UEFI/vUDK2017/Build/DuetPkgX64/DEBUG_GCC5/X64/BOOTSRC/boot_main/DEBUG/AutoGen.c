...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xe48fe3df, 0xdc88, 0x49f7, {0xbb, 0xa2, 0x6a, 0x4d, 0x02, 0x79, 0x22, 0x33}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BOOTLOAD";
...
{
  return UEFIBootMain (ImageHandle, SystemTable);
}
